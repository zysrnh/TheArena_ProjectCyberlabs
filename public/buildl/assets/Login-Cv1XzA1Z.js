import{r as f,a as h,j as e,H as u,L as g,b}from"./app-Bptq4u_V.js";import{N as y,X as w}from"./Navigation-F9k5dRpI.js";import{C as j}from"./circle-check-big-hywnPFjG.js";import{C as m}from"./circle-alert-CrG1A2H8.js";import{M as N}from"./mail-hiDhJ8hN.js";import{L as v,E as k,a as C}from"./lock-C1_tVAar.js";import{U as D}from"./user-DvjZD9lX.js";/* empty css            */function B(){const[r,p]=f.useState(!1),[s,t]=f.useState(null),{data:n,setData:o,post:x,processing:d,errors:i}=h({email:"",password:"",remember:!1}),c=a=>{a.preventDefault(),x("/login",{onSuccess:()=>{t({type:"success",message:"Login berhasil! Mengalihkan ke halaman profil..."}),setTimeout(()=>{b.visit("/profile")},1500)},onError:l=>{(l.email||l.password)&&(t({type:"error",message:l.email||l.password||"Email atau password salah"}),setTimeout(()=>t(null),5e3))}})};return e.jsxs(e.Fragment,{children:[e.jsx(u,{title:"Login"}),e.jsx("style",{children:`
